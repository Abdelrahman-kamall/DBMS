...
public class Main {
	public static void main(String[] args) {
		...
		Object[][] cond = { { "column_name2", "value3" }, { "0", "0" }, { "0", "0" } };
		Update u = new Update("db1", "t1", x, cond);
		System.out.print(u.getCount());

		// createTable ct = new createTable("table1","name","mark");

		// String[][] x = {{"column_name1", "column_name2", "column_name3"},
		...
		// xx[1]=null;
		//// xx[2]=null;
		// String[][] x = {{"column_name1", "column_name2", "column_name3"}, {"Integer",
		// "String", "String"}};
		...
		// System.out.println(Arrays.deepToString(selectTable.selectCols("dbs\\db1\\t2.xml",
		// "t2", c, o)));
